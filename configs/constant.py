...
#
MODEL_CHATBOT_BASIC = "gemini-2.5-flash"
MODEL_CHATBOT_REFERENCE = "gemini-2.5-flash"
MODEL_CHATBOT_CHART = "gemini-2.5-flash"
MODEL_CHATBOT_SUGGESTION = "gemini-2.5-flash-lite"
MODEL_CHATBOT_CUSTOM_PROMPT = os.getenv("GEMINI_CHAT_MODEL", "gemini-2.5-flash-lite")
MODEL_PROVINCE_MERGER = "gemini-2.5-flash"
MODEL_KAT = "gemini-2.5-flash"
MODEL_SCHOOL = "gemini-2.5-flash"
